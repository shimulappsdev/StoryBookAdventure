...
import com.storybookadventure.databinding.FragmentSeeAllBinding;
...
public class SeeAllFragment extends Fragment {
    ...
    FragmentSeeAllBinding binding;
    PopularAdapter seeAllAdapter;
    List<Book> allBooks;
    List<Category> categoryList;
    Intent intent;
    String category, seeAll, headText;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentSeeAllBinding.inflate(getLayoutInflater(), container, false);
        ...
        headText = intent.getStringExtra("headText");

        if (headText != null){
            binding.headText.setText(headText+" Books");
        }
        ...
        if (seeAll != null && seeAll.equals("seeAll")){
            seeAllAdapter = new PopularAdapter(getContext(), allBooks);
            binding.seeAllRecyclerView.setAdapter(seeAllAdapter);
        }
